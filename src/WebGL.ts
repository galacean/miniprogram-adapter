export const WebGLRenderingContext = {
    GL_CMD_ACTIVE_TEXTURE : 1,
    GL_CMD_ATTACH_SHADER : 2,
    GL_CMD_BIND_ATTRIB_LOCATION : 3,
    GL_CMD_BIND_BUFFER : 4,
    GL_CMD_BIND_FRAME_BUFFER : 5,
    GL_CMD_BIND_RENDER_BUFFER : 6,
    GL_CMD_BIND_TEXTURE : 7,
    GL_CMD_BLEND_COLOR : 8,
    GL_CMD_BLEND_EQUATION : 9,
    GL_CMD_BLEND_EQUATION_SEPARATE : 10,

    GL_CMD_BLEND_FUNC : 11,
    GL_CMD_BLEND_FUNC_SEPARATE : 12,
    GL_CMD_BUFFER_DATA : 13,
    GL_CMD_BUFFER_SUB_DATA : 14,
    GL_CMD_CHECK_FRAME_BUFFER_STATUS : 15,
    GL_CMD_CLEAR : 16,
    GL_CMD_CLEAR_COLOR : 17,
    GL_CMD_CLEAR_DEPTH : 18,
    GL_CMD_CLEAR_STENCIL : 19,
    GL_CMD_COLOR_MASH : 20,

    GL_CMD_COMPILE_SHADER : 21,
    GL_CMD_COMPRESSED_TEX_IMAGE_2D : 22,
    GL_CMD_COMPRESSED_TEX_SUB_IMAGE_2D : 23,
    GL_CMD_COPY_TEX_IMAGE_2D : 24,
    GL_CMD_COPY_TEX_SUB_IMAGE_2D : 25,
    GL_CMD_CREATE_BUFFER : 26,
    GL_CMD_CREATE_FRAME_BUFFER : 27,
    GL_CMD_CREATE_PROGRAME : 28,
    GL_CMD_CREATE_RENDER_BUFFER : 29,
    GL_CMD_CREATE_SHADER : 30,

    GL_CMD_CREATE_TEXTURE : 31,
    GL_CMD_CULL_FACE : 32,
    GL_CMD_DELETE_BUFFER : 33,
    GL_CMD_DELETE_FRAME_BUFFER : 34,
    GL_CMD_DELETE_PROGRAM : 35,
    GL_CMD_DELETE_RENDER_BUFFER : 36,
    GL_CMD_DELETE_SHADER : 37,
    GL_CMD_DELETE_TEXTURE : 38,
    GL_CMD_DEPTH_FUNC : 39,
    GL_CMD_DEPTH_MASK : 40,

    GL_CMD_DEPTH_RANGE : 41,
    GL_CMD_DETACH_SHADER : 42,
    GL_CMD_DISABLE : 43,
    GL_CMD_DISABLE_VERTEX_ATTRIB_ARRAY : 44,
    GL_CMD_DRAW_ARRAYS : 45,
    GL_CMD_DRAW_ELEMENTS : 46,
    GL_CMD_ENABLE : 47,
    GL_CMD_ENABLE_VERTEX_ATTRIB_ARRAY : 48,
    GL_CMD_FINISH : 49,
    GL_CMD_FLUSH : 50,

    GL_CMD_FRAME_BUFFER_RENDER_BUFFER : 51,
    GL_CMD_FRAME_BUFFER_TEXTURE_2D : 52,
    GL_CMD_FRONT_FACE : 53,
    GL_CMD_GENERATE_MIPMAP : 54,
    GL_CMD_GET_ACTIVE_ATTRIB : 55,
    GL_CMD_GET_ACTIVE_UNIFORM : 56,
    GL_CMD_GET_ATTACHED_SHADERS : 57,
    GL_CMD_GET_ATTRIB_LOCATION : 58,
    GL_CMD_GET_BUFFER_PARAMETER : 59,
    GL_CMD_GET_COMTEXT_ATTRIBUTES : 60,

    GL_CMD_GET_ERROR : 61,
    GL_CMD_GET_EXTENSION : 62,
    GL_CMD_GET_FRAME_BUFFER_ATTACHMENT_PARAMETER : 63,
    GL_CMD_GET_PARAMETER : 64,
    GL_CMD_GET_PROGRAM_INFO_LOG : 65,
    GL_CMD_GET_PROGRAM_PARAMETER : 66,
    GL_CMD_GET_RENDER_BUFFER_PARAMETER : 67,
    GL_CMD_GET_SHADER_INFO_LOG : 68,
    GL_CMD_GET_SHADER_PARAMETER : 69,
    GL_CMD_GET_SHADER_PRECISION_FORMAT : 70,

    GL_CMD_GET_SHADER_SOURCE : 71,
    GL_CMD_GET_SUPPORTED_EXTENSIONS : 72,
    GL_CMD_GET_TEX_PARAMETER : 73,
    GL_CMD_GET_UNIFORM : 74,
    GL_CMD_GET_UNIFORM_LOCATION : 75,
    GL_CMD_GET_VERTEX_ATTRIB : 76,
    GL_CMD_GET_VERTEX_ATTRIB_OFFSET : 77,
    GL_CMD_HINT : 78,
    GL_CMD_IS_BUFFER : 79,
    GL_CMD_IS_CONTEXT_LOST : 80,

    GL_CMD_IS_ENABLED : 81,
    GL_CMD_IS_FRAME_BUFFER : 82,
    GL_CMD_IS_PROGRAM : 83,
    GL_CMD_IS_RENDER_BUFFER : 84,
    GL_CMD_IS_SHADER : 85,
    GL_CMD_IS_TEXTURE : 86,
    GL_CMD_LINE_WIDTH : 87,
    GL_CMD_LINK_PROGRAM : 88,
    GL_CMD_PIXEL_STOREI : 89,
    GL_CMD_POLYGON_OFFSET : 90,

    GL_CMD_READ_PIXELS : 91,
    GL_CMD_RENDER_BUFFER_STORAGE : 92,
    GL_CMD_SAMPLE_COVERAGE : 93,
    GL_CMD_SCISSOR : 94,
    GL_CMD_SHADER_SOURCE : 95,
    GL_CMD_STENCIL_FUNC : 96,
    GL_CMD_STENCIL_FUNC_SEPARATE : 97,
    GL_CMD_STENCIL_MASK : 98,
    GL_CMD_STENCIL_MASK_SEPARATE : 99,
    GL_CMD_STENCIL_OP : 100,

    GL_CMD_STENCIL_OP_SEPARATE : 101,
    GL_CMD_TEX_IMAGE_2D : 102,
    GL_CMD_TEX_PARAMETER_F : 103,
    GL_CMD_TEX_PARAMETER_I : 104,
    GL_CMD_TEX_SUB_IMAGE_2D : 105,
    GL_CMD_UNIFORM_1_I : 106,
    GL_CMD_UNIFORM_2_I : 107,
    GL_CMD_UNIFORM_3_I : 108,
    GL_CMD_UNIFORM_4_I : 109,
    GL_CMD_UNIFORM_1_F : 110,
    GL_CMD_UNIFORM_2_F : 111,
    GL_CMD_UNIFORM_3_F : 112,
    GL_CMD_UNIFORM_4_F : 113,
    GL_CMD_UNIFORM_1_IV : 114,
    GL_CMD_UNIFORM_2_IV : 115,
    GL_CMD_UNIFORM_3_IV : 116,
    GL_CMD_UNIFORM_4_IV : 117,
    GL_CMD_UNIFORM_1_FV : 118,
    GL_CMD_UNIFORM_2_FV : 119,
    GL_CMD_UNIFORM_3_FV : 120,
    GL_CMD_UNIFORM_4_FV : 121,
    GL_CMD_UNIFORM_MATRIX2FV : 122,
    GL_CMD_UNIFORM_MATRIX3FV : 123,
    GL_CMD_UNIFORM_MATRIX4FV : 124,

    GL_CMD_USE_PROGRAM : 127,
    GL_CMD_VALIDATE_PROGRAM : 128,

    GL_CMD_VERTEX_ATTRIB_1FV : 129,
    GL_CMD_VERTEX_ATTRIB_2FV : 130,
    GL_CMD_VERTEX_ATTRIB_3FV : 131,
    GL_CMD_VERTEX_ATTRIB_4FV : 132,
    GL_CMD_VERTEX_ATTRIB_1F : 133,
    GL_CMD_VERTEX_ATTRIB_2F : 134,
    GL_CMD_VERTEX_ATTRIB_3F : 135,
    GL_CMD_VERTEX_ATTRIB_4F : 136,
    GL_CMD_VERTEX_ATTRIB_POINTER : 137,
    GL_CMD_VIEWPORT : 138
};
